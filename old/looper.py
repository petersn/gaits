...
def index_to_model_path(i):
	return os.path.join(args.prefix, "models", "model-%03i.nn" % i)
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(
		description="""
Performs the main loop of alternating game generation (via generate_games.py)
...
the initial PREFIX/models/model-001.nn file. Then looper.py will run in a main loop of:
...
""",
	...
	parser.add_argument("--visits", metavar="N", type=int, default=50, help="At each move in the self-play games perform MCTS until the root node has N visits.")
	parser.add_argument("--game-count", metavar="N", type=int, default=40, help="Minimum number of games to generate per iteration.")
	parser.add_argument("--training-steps-const", metavar="N", type=int, default=100, help="Base number of training steps to perform per iteration.")
	...
	parser.add_argument("--parallel-games-processes", metavar="N", type=int, default=4, help="Number of games processes to run in parallel.")
